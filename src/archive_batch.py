...
# -------------------------------------------------------------- folder paths
# Comparing what the archiver reports against what this app resolved. Read by
# the service alone, which is why they stayed behind when the run/item rows
# moved to ``src/archive_store.py`` (#186).
